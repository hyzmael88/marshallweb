...
function Proceso() {
  ...
  return (
    <div className='w-full px-4 lg:px-14 h-full lg:h-[605px] flex flex-col lg:flex-row justify-between items-center py-[60px] gap-8 '>
        ...
        <div className='w-full lg:w-full xl:w-[721px] h-[270px] lg:h-[411px] rounded-[19px] bg-[#233E9E] flex flex-col  justify-center px-8 md:gap-4 lg:gap-0'>
            ...
            <div className='w-full h-full flex flex-col justify-center items-center   '>
                {
                    ...
                    <div className=' h-full flex flex-row lg:flex-col text-center justify-center lg:text-left'>
                        <div className='w-full lg:mr-4'>
                            ...
                            <p className='font-paragraph text-[16px] w-full xl:w-[477px] px-8 lg:px-[0px] '>{item.description}</p>
                        </div>
                    </div>
                </div>
